...
document.querySelector('#button-hp8tv').addEventListener('click', async () => {
  ...
  form.set('html', `<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta http-equiv='X-UA-Compatible' content='IE=edge'> <meta name='viewport' content='width=device-width, initial-scale=1.0'> </head> <body style='font-family: system-ui, sans-serif; background-color: #7EC8E3; margin: 0; padding: 20px;'> <table width='100%' cellspacing='0' cellpadding='0' border='0' style='background-color: #7EC8E3; padding: 20px;'> <tr> <td align='center'> <table width='600' cellspacing='0' cellpadding='20' border='0' style='background-color: white; border-radius: 8px;'> <tr></tr> <tr> <td style='font-size: 16px; line-height: 1.6;'> <p>Hi, ${data.details.to}!</p> <p>We wanted to let you know that we have successfully received your booking! You have scheduled it for <strong>${data.suggest[passfrom].date}</strong> at <strong>${data.suggest[passfrom].time}</strong>. We will be sending calendar invites momentarily.</p> <img src='https://cdn.prestonkwei.com/circlewithcheck-green.png' style='width: 200px; height: 200px; display: block; margin: 0 auto;'> <p>If you need to make any changes, please let ${data.details.from} know by replying to this email.</p> <a href='https://schedule.prestonkwei.com/confirmed.html?passthrough=${JSON.stringify(data)}'><p>View more details.</p></a></td> </tr> <tr> <td style='font-family: system-ui, sans-serif; font-size: 10px; text-align: center;'> <hr> <p>This email was sent on behalf of ${data.details.eFrom} who sent you this invite.</p> <p>PrestonKwei.com ⋅ PO Box 20987 ⋅ Oakland, CA 94620</p> <p>This is an unmonitored email address. Responses will not be received.</p> <a href='https://prestonkwei.com'><p>prestonkwei.com</p></a> </td> </tr> </table> </td> </tr> </table> </body> </html>`.replace(/undefined/g, ''))
  form.set('content', `Sorry, this email didn't format correctly. Please contact the person who sent you this for help and more information. You can delete this email (or keep it, we won't mind).\n\nERR: html fail-- to content.`)
  if (sent != true) {
